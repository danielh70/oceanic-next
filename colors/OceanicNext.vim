...
call <sid>hi('Include',                    s:base0E, '',       '',          '')
call <sid>hi('Keyword',                    s:base0E, '',       '',          '')
call <sid>hi('Label',                      s:base0E, '',       '',          '')
call <sid>hi('Number',                     s:base09, '',       '',          '')
call <sid>hi('Operator',                   s:base0C, '',       '',          '')
...
call <sid>hi('Tag',                        s:base0E, '',       '',          '')
call <sid>hi('Todo',                       s:base0A, s:base01, '',          '')
call <sid>hi('Type',                       s:base0E, '',       'NONE',          '')
call <sid>hi('Typedef',                    s:base0E, '',       '',          '')
...
call <sid>hi('jsxTagName',                 s:base08, '',       '',          '')
call <sid>hi('jsxTag',                     s:base08, '',       '',          '')
call <sid>hi('jsSpreadOperator',           s:base0C, '',       '',          '')
call <sid>hi('jsThis',                     s:base08, '',       s:italic,          '')
call <sid>hi('jsNull',                     s:base09, '',       '',          '')
call <sid>hi('jsUndefined',                s:base09, '',       '',          '')
call <sid>hi('jsxAttrib',                  s:base0E, '',       '',          '')
call <sid>hi('jsxBraces',                  s:base0C, '',       '',          '')
call <sid>hi('jsxAttribKeyword',           s:base0E, '',       '',          '')
call <sid>hi('jsxComponentName',           s:base0A, '',       s:bold,          '')
